...
<div class="layout-aside">
    ...
    <!-- :router="true"简写成 router -->
    <!-- router 开启路由 -->
<el-menu :collapse="collaspse" router :style="{width: collaspse ? '60px': '230px'}" background-color="#353b4e" text-color="#adafb5" active-text-color="#ffd04b">
    <!-- 导航组件 -->
